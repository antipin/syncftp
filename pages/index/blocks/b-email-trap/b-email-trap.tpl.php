<div class="b-email-trap">

    <div class="b-email-trap__slide b-email-trap__slide_type_form">

        <form class="b-email-trap__form">
            ...
            <div class="b-email-trap__item b-email-trap__type_description">
                We never rent or sell yor personal information.
            </div>
        </form>
    ...
    <div class="b-email-trap__slide b-email-trap__slide_type_success">

        <div class="b-email-trap__success">
            <h3>Thank you for your interest!</h3>
            <p>We'll contact you the day we lauch.</p>
        </div>
